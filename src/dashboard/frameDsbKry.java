 ...
 * @author RZ
 */
public class frameDsbKry extends javax.swing.JInternalFrame {
	...
	public frameDsbKry(JDesktopPane panel, Session session) {
		initComponents();
		mainPanel = panel;
		sess = session;
    ...
    private void initComponents() {
        ...
        monthlyIc1 = new javax.swing.JLabel();
        ...
        monthlyIc1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/icons8_age_52px.png"))); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(panelContainer1, javax.swing.GroupLayout.DEFAULT_SIZE, 97, Short.MAX_VALUE)
                    .addComponent(panelContainer, javax.swing.GroupLayout.DEFAULT_SIZE, 97, Short.MAX_VALUE))
	...
	private String getMonthlyTrk() {
		...
		try {
			...
			Logger.getLogger(frameDsbKry.class.getName()).log(Level.SEVERE, null, ex);
		}
		return "0";
	}
    ...
    private javax.swing.JLabel monthlyIc1;
